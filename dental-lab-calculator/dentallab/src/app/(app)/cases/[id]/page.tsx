...
import type { Case, CaseMaterialUsage, MaterialWithStock, CaseStatus } from '@/types'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="rounded-xl border bg-card shadow-sm p-5">
            <h2 className="text-sm font-semibold mb-4">Case Information</h2>
            ...
            {(c.tooth_numbers || c.shade) && (
              <div className="mt-4 pt-4 border-t flex gap-6 text-sm">
                {c.tooth_numbers && (
                  <div>
                    <p className="text-xs text-muted-foreground mb-1">Tooth Numbers</p>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              {usages.length} material{usages.length !== 1 ? 's' : ''} assigned to this case
              {!editable && ' · Case is locked for editing'}
            </p>
          </div>
          {editable && (
