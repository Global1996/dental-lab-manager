...
import {
  ...
  Briefcase, BarChart3, AlertTriangle, Users2, ChevronRight, FlaskConical, Truck, ClipboardList, History,
} from 'lucide-react'
...
const NAV: NavItem[] = [
  { label: 'Panou de control', href: '/dashboard', icon: LayoutDashboard },
  { label: 'Materiale',        href: '/materials', icon: Package2 },
  { label: 'Stoc',             href: '/stock',     icon: ArrowLeftRight },
  { label: 'Cazuri',           href: '/cases',     icon: Briefcase },
  { label: 'Rapoarte',         href: '/reports',   icon: BarChart3 },
  { label: 'Furnizori',         href: '/suppliers',       icon: Truck },
  { label: 'Comenzi Achiziție', href: '/purchase-orders', icon: ClipboardList },
  { label: 'Jurnal activitate', href: '/audit',     icon: History, roles: ['admin', 'manager'] },
  { label: 'Utilizatori',      href: '/users',     icon: Users2, roles: ['admin'] },
]
        ...
        <div className="mx-3 mb-3 rounded-lg bg-red-50 border border-red-200 px-3 py-2">
          <div className="flex items-center gap-1.5">
            ...
            <p className="text-xs font-semibold text-red-700">
              {alertCount} {alertCount === 1 ? 'alertă necesită atenție' : 'alerte necesită atenție'}
            </p>
          </div>
        </div>
      )}
