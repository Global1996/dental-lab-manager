    ...
    <div className="space-y-6 max-w-[1400px]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <StatCard
          ...
          sub={alertSummary.critical > 0 ? `${alertSummary.critical} critical` : 'No critical issues'}
        ...
        <StatCard
          ...
          iconBg="bg-rose-50"
          sub={`${monthlyCases.length} completed case${monthlyCases.length !== 1 ? 's' : ''}`}
        />
        <StatCard
          ...
          trendText={`Revenue: ${formatCurrency(monthlyRevenue)}`}
        />
      </div>
          ...
          <section className="rounded-xl border bg-card shadow-sm overflow-hidden">
            <div className="px-5 py-4 border-b bg-muted/20">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                By quantity · {now.toLocaleString('en-US', { month: 'long' })}
              </p>
            </div>
            <div className="px-5 py-4">
