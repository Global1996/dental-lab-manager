...
const TYPE_CFG: Record<string, {
  ...
  in:         { label: 'Intrare Stoc',    Icon: ArrowDownToLine,  cls: 'bg-emerald-50 text-emerald-700' },
  out:        { label: 'Ieșire Stoc',   Icon: ArrowUpFromLine,  cls: 'bg-red-50     text-red-700'     },
  case_usage: { label: 'Utilizat pe Caz',  Icon: FlaskConical,     cls: 'bg-blue-50    text-blue-700'    },
  adjustment: { label: 'Ajustare',  Icon: SlidersHorizontal,cls: 'bg-slate-50   text-slate-700'   },
  return:     { label: 'Retur',      Icon: RotateCcw,        cls: 'bg-amber-50   text-amber-700'   },
  expired:    { label: 'Expirat',     Icon: AlertCircle,      cls: 'bg-zinc-50    text-zinc-500'    },
}
      ...
      <table className="w-full text-sm min-w-[520px]">
        <thead>
          <tr className="border-b">
            <th className="text-left pb-2.5 pt-1 px-1 text-xs font-semibold text-muted-foreground uppercase tracking-wide">Tip</th>
            <th className="text-left pb-2.5 pt-1 px-2 text-xs font-semibold text-muted-foreground uppercase tracking-wide">Material</th>
            <th className="text-right pb-2.5 pt-1 px-2 text-xs font-semibold text-muted-foreground uppercase tracking-wide">Cant.</th>
            <th className="text-right pb-2.5 pt-1 px-2 text-xs font-semibold text-muted-foreground uppercase tracking-wide hidden sm:table-cell">Valoare</th>
            <th className="text-right pb-2.5 pt-1 px-1 text-xs font-semibold text-muted-foreground uppercase tracking-wide">Când</th>
          </tr>
        </thead>
